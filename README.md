...
A local-first code intelligence system that turns your codebase into a searchable, queryable knowledge base — accessible from your terminal or WhatsApp via [OpenClaw](https://github.com/nichochar/openclaw).
